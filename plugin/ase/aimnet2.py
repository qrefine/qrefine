...
class AIMNet2Calculator(Calculator):
    ...
    def __init__(self, model_file='ani/aimnet2_qr_pbeh_cpcm_221209.jpt', cutoff=None, use_coulomb=False, coulomb_cutoff=15.0):
        super().__init__()
    ...
    def check_trained_atoms(self):
        if not np.in1d(self.atoms.numbers, self.species):
