...
from qrefine.core.utils import yoink_utils
...
def run(prefix = "tst_07"):
  ...
  yoink_utils.write_yoink_infiles(os.path.join(qr_core,"./cluster.xml"),
                                  os.path.join(qr_core,"./qmmm.xml"),
                                  ph,
                                  os.path.join(qr_core,"plugin/yoink/dat"))
  pyoink=PYoink(os.path.join(qr_core,"plugin/yoink/Yoink-0.0.1.jar"),
                os.path.join(qr_core,"plugin/yoink/dat"),
                os.path.join(qr_core,"./cluster.xml"))
